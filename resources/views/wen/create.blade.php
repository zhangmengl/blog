...
<center><h2>文章添加<a href="{{url('/wen/index')}}" style="float:right" class="btn btn-default">列表</a></h2></center><br>
...
<form action="{{url('wen/store')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">文章标题</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="wen_name" id="firstname" 
				   placeholder="请输入文章标题">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<select name="wenf_id">
                ...
                @foreach ($wenf as $v)
                    <option value="{{$v->wenf_id}}">{{$v->wenf_name}}</option>
                @endforeach
            </select>	   
		</div>
	</div>
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="radio" name="wen_an" value="1" checked>普通	
            <input type="radio" name="wen_an" value="2" >置顶	   
		</div>
	</div>
    <div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="wen_man" id="firstname" 
				   placeholder="请输入文章作者">
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="wen_email" id="firstname" 
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="wen_guan" id="firstname" 
				   placeholder="请输入关键字">
